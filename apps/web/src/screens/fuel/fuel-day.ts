...
/** Saved foods, and typed labels worth saving. Read by the Foods screen and the Log food sheet. */
export const useFuelItems = () => useQuery({ queryKey: FUEL_ITEMS_KEY, queryFn: () => api.get<FuelItems>("/api/fuel/items") });
